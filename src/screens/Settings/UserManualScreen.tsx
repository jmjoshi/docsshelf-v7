...
export default function UserManualScreen() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      color: '#FF6B6B',
      content: [
        '🏷️ Create Tags: Settings → Tag Management → + button → Enter name, choose color → Save',
        '🎨 Color Palette: 20 colors available for visual tag identification',
        '✏️ Edit Tag: Tag list → Edit icon → Update name/color → Save',
        '🗑️ Delete Tag: Tag list → Delete icon → Confirm (shows document count)',
        '🔍 Search Tags: Use search bar to find specific tags quickly',
        '📊 Tag Statistics: View total tags, tagged documents, and average tags per document',
        '📝 Document Tagging: Edit document → Tags section → Select tags → Multiple tags allowed',
        '🏷️ Tag Examples: "urgent", "2024", "taxes", "personal", "important", "work"',
        '💡 Best Practices: Keep tags short, use consistent naming, limit to 3-5 per document',
        '🔗 Tag Search: Documents screen → Search by tag name to filter tagged documents',
      ],
    },
    {
      id: 'search',
